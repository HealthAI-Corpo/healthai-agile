...
> _à définir lors du sprint planning — ex : "Livrer l'enregistrement des séances, l'estimation calorique ML et l'historique utilisateur."_

---

## User Stories candidates (Sprint 2)
...
| [#10](https://github.com/HealthAI-Corpo/healthai-agile/issues/10) | US 6 — Historique séances | 2 | P2 |
...
_à compléter lors du sprint planning_
